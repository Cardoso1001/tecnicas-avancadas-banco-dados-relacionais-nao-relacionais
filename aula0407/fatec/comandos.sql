...
================================================
FATEC Ourinhos — Novos alunos e matrículas
+25 alunos (ra 76–100) distribuídos nas 5 turmas
...
-- ══════════════════════════════════════════════════════════
-- 1. NOVOS 25 ALUNOS (5 por turma, ra 76–100)
-- ══════════════════════════════════════════════════════════

-- ── Turma 1 — ADS ─────────────────────────────────────────
INSERT INTO aluno (nome, cpf, email_pessoal, email_institucional, telefone, data_nasc, endereco, cidade, codturma) VALUES
('Alexsandro Moura Pinto',      '076.076.076-76', 'alexsandro.pinto@gmail.com',    'alexsandro.pinto@fatec.sp.gov.br',    '(14) 99176-0076', '2003-04-05', 'Rua Acre, 900',           'Ourinhos',       1),
('Bruna Lacerda Figueiredo',    '077.077.077-77', 'bruna.figueiredo@gmail.com',     'bruna.figueiredo@fatec.sp.gov.br',    '(14) 99177-0077', '2004-07-18', 'Rua Amazonas, 911',       'Salto Grande',   1),
('Caique Santana Vilas Boas',   '078.078.078-78', 'caique.vilasboas@gmail.com',     'caique.vilasboas@fatec.sp.gov.br',    '(14) 99178-0078', '2002-10-30', 'Rua Bahia, 922',          'Ourinhos',       1),
('Daiane Ferraz Magalhães',     '079.079.079-79', 'daiane.magalhaes@gmail.com',     'daiane.magalhaes@fatec.sp.gov.br',    '(14) 99179-0079', '2003-02-12', 'Rua Ceará, 933',          'Ribeirão do Sul',1),
('Elton Carvalho Meireles',     '080.080.080-80', 'elton.meireles@gmail.com',       'elton.meireles@fatec.sp.gov.br',      '(14) 99180-0080', '2004-05-24', 'Rua Goiás, 944',          'Ourinhos',       1);

-- ── Turma 2 — Gestão Empresarial ──────────────────────────
INSERT INTO aluno (nome, cpf, email_pessoal, email_institucional, telefone, data_nasc, endereco, cidade, codturma) VALUES
('Fabíola Reis Cavalcante',     '081.081.081-81', 'fabiola.cavalcante@gmail.com',   'fabiola.cavalcante@fatec.sp.gov.br',  '(14) 99181-0081', '2002-08-09', 'Rua Paraná, 955',         'Ourinhos',       2),
('Giovanni Alves Pacheco',      '082.082.082-82', 'giovanni.pacheco@gmail.com',     'giovanni.pacheco@fatec.sp.gov.br',    '(14) 99182-0082', '2003-11-21', 'Rua Piauí, 966',          'Chavantes',      2),
('Heloísa Braga Mendonça',      '083.083.083-83', 'heloisa.mendonca@gmail.com',     'heloisa.mendonca@fatec.sp.gov.br',    '(14) 99183-0083', '2004-03-06', 'Rua Rio Grande, 977',     'Ourinhos',       2),
('Ivan Teles Noronha',          '084.084.084-84', 'ivan.noronha@gmail.com',         'ivan.noronha@fatec.sp.gov.br',        '(14) 99184-0084', '2002-06-19', 'Rua São Paulo, 988',      'Canitar',        2),
('Jéssica Dutra Wanderley',     '085.085.085-85', 'jessica.wanderley@gmail.com',    'jessica.wanderley@fatec.sp.gov.br',   '(14) 99185-0085', '2003-09-01', 'Rua Mato Grosso, 999',   'Ourinhos',       2);

-- ── Turma 3 — Logística ───────────────────────────────────
INSERT INTO aluno (nome, cpf, email_pessoal, email_institucional, telefone, data_nasc, endereco, cidade, codturma) VALUES
('Kleber Sousa Travassos',      '086.086.086-86', 'kleber.travassos@gmail.com',     'kleber.travassos@fatec.sp.gov.br',    '(14) 99186-0086', '2002-12-14', 'Rua Tocantins, 1010',    'Ourinhos',       3),
('Lorena Fonseca Quirino',      '087.087.087-87', 'lorena.quirino@gmail.com',       'lorena.quirino@fatec.sp.gov.br',      '(14) 99187-0087', '2004-01-27', 'Rua Espírito Santo, 1021','Salto Grande',  3),
('Murillo Esteves Siqueira',    '088.088.088-88', 'murillo.siqueira@gmail.com',     'murillo.siqueira@fatec.sp.gov.br',    '(14) 99188-0088', '2003-04-10', 'Rua Minas Gerais, 1032', 'Ourinhos',       3),
('Nádia Pinto Cerqueira',       '089.089.089-89', 'nadia.cerqueira@gmail.com',      'nadia.cerqueira@fatec.sp.gov.br',     '(14) 99189-0089', '2002-07-23', 'Rua São Paulo, 1043',    'Ourinhos',       3),
('Osvaldo Lima Barretto',       '090.090.090-90', 'osvaldo.barretto@gmail.com',     'osvaldo.barretto@fatec.sp.gov.br',    '(14) 99190-0090', '2003-10-05', 'Rua Pará, 1054',          'Ribeirão do Sul',3);

-- ── Turma 4 — Agronegócio ─────────────────────────────────
INSERT INTO aluno (nome, cpf, email_pessoal, email_institucional, telefone, data_nasc, endereco, cidade, codturma) VALUES
('Pamela Vieira Botelho',       '091.091.091-91', 'pamela.botelho@gmail.com',       'pamela.botelho@fatec.sp.gov.br',      '(14) 99191-0091', '2004-01-18', 'Rua Alagoas, 1065',      'Ourinhos',       4),
('Quirino Abreu Landim',        '092.092.092-92', 'quirino.landim@gmail.com',       'quirino.landim@fatec.sp.gov.br',      '(14) 99192-0092', '2002-04-01', 'Rua Rio de Janeiro, 1076','Ourinhos',      4),
('Rosiane Cordeiro Sena',       '093.093.093-93', 'rosiane.sena@gmail.com',         'rosiane.sena@fatec.sp.gov.br',        '(14) 99193-0093', '2003-06-14', 'Rua Roraima, 1087',      'Chavantes',      4),
('Sérgio Nunes Falcão',         '094.094.094-94', 'sergio.falcao@gmail.com',        'sergio.falcao@fatec.sp.gov.br',       '(14) 99194-0094', '2004-09-27', 'Rua Amapá, 1098',        'Ourinhos',       4),
('Tainá Rocha Guedes',          '095.095.095-95', 'taina.guedes@gmail.com',         'taina.guedes@fatec.sp.gov.br',        '(14) 99195-0095', '2002-12-10', 'Rua Pernambuco, 1109',   'Canitar',        4);

-- ── Turma 5 — Produção Sucroalcooleira ────────────────────
INSERT INTO aluno (nome, cpf, email_pessoal, email_institucional, telefone, data_nasc, endereco, cidade, codturma) VALUES
('Ulisses Campos Rezende',      '096.096.096-96', 'ulisses.rezende@gmail.com',      'ulisses.rezende@fatec.sp.gov.br',     '(14) 99196-0096', '2003-03-23', 'Rua Sergipe, 1120',      'Ourinhos',       5),
('Valéria Gomes Maciel',        '097.097.097-97', 'valeria.maciel@gmail.com',       'valeria.maciel@fatec.sp.gov.br',      '(14) 99197-0097', '2004-06-05', 'Rua Paraíba, 1131',      'Salto Grande',   5),
('Wenderson Farias Leal',       '098.098.098-98', 'wenderson.leal@gmail.com',       'wenderson.leal@fatec.sp.gov.br',      '(14) 99198-0098', '2002-09-18', 'Rua Rondônia, 1142',     'Ourinhos',       5),
('Xênia Barbosa Lacerda',       '099.099.099-99', 'xenia.lacerda@gmail.com',        'xenia.lacerda@fatec.sp.gov.br',       '(14) 99199-0099', '2003-12-01', 'Rua Acre, 1153',         'Ourinhos',       5),
('Yago Pedroso Monteiro',       '100.100.100-00', 'yago.monteiro@gmail.com',        'yago.monteiro@fatec.sp.gov.br',       '(14) 99100-0100', '2004-02-14', 'Rua Amazonas, 1164',     'Ribeirão do Sul',5);

-- ══════════════════════════════════════════════════════════
-- 2. MATRÍCULAS (50 registros, status variados)
--
-- Mapeamento turma → disciplinas do curso:
--   Turma 1 (ADS)       → coddisc 1,2,3,4
--   Turma 2 (Gestão)    → coddisc 5,6,7,8
--   Turma 3 (Logística) → coddisc 9,10,11,12
--   Turma 4 (Agroneg.)  → coddisc 13,14,15,16
--   Turma 5 (Sucroalc.) → coddisc 17,18,19,20
--
-- Status: ~25 Ativa | ~15 Concluída | ~10 Trancada
-- Notas lançadas apenas em Concluída (e algumas Ativas)
-- ══════════════════════════════════════════════════════════

INSERT INTO matricula (ra, coddisc, codturma, data_matricula, status, nota) VALUES

-- ── Turma 1 — ADS (disciplinas 1–4) ──────────────────────
-- Alunos ra 1,2,3 (seed original) + ra 76,77,78 (novos)

-- ra 1 · 3 disciplinas
(1,  1, 1, '2025-02-10', 'Concluída', 8.5),
(1,  2, 1, '2025-02-10', 'Concluída', 7.0),
(1,  3, 1, '2025-02-10', 'Ativa',     NULL),

-- ra 2 · 2 disciplinas
(2,  1, 1, '2025-02-11', 'Concluída', 9.0),
(2,  4, 1, '2025-02-11', 'Trancada',  NULL),

-- ra 3 · 2 disciplinas
(3,  2, 1, '2025-02-12', 'Ativa',     6.5),
(3,  3, 1, '2025-02-12', 'Ativa',     NULL),

-- ra 76 (novo) · 2 disciplinas
(76, 1, 1, '2025-03-01', 'Ativa',     NULL),
(76, 4, 1, '2025-03-01', 'Trancada',  NULL),

-- ra 77 (novo) · 1 disciplina
(77, 2, 1, '2025-03-02', 'Ativa',     NULL),

-- ── Turma 2 — Gestão (disciplinas 5–8) ───────────────────
-- Alunos ra 16,17,18 (seed) + ra 81,82 (novos)

-- ra 16 · 3 disciplinas
(16, 5, 2, '2025-02-10', 'Concluída', 7.5),
(16, 6, 2, '2025-02-10', 'Concluída', 8.0),
(16, 7, 2, '2025-02-10', 'Ativa',     NULL),

-- ra 17 · 2 disciplinas
(17, 5, 2, '2025-02-11', 'Trancada',  NULL),
(17, 8, 2, '2025-02-11', 'Ativa',     5.0),

-- ra 18 · 2 disciplinas
(18, 6, 2, '2025-02-12', 'Concluída', 6.0),
(18, 7, 2, '2025-02-12', 'Ativa',     NULL),

-- ra 81 (novo) · 2 disciplinas
(81, 5, 2, '2025-03-03', 'Ativa',     NULL),
(81, 8, 2, '2025-03-03', 'Trancada',  NULL),

-- ra 82 (novo) · 1 disciplina
(82, 6, 2, '2025-03-04', 'Ativa',     NULL),

-- ── Turma 3 — Logística (disciplinas 9–12) ───────────────
-- Alunos ra 31,32,33 (seed) + ra 86,87 (novos)

-- ra 31 · 3 disciplinas
(31,  9, 3, '2025-02-10', 'Concluída', 9.5),
(31, 10, 3, '2025-02-10', 'Concluída', 8.0),
(31, 11, 3, '2025-02-10', 'Ativa',     NULL),

-- ra 32 · 2 disciplinas
(32,  9, 3, '2025-02-11', 'Ativa',     7.0),
(32, 12, 3, '2025-02-11', 'Trancada',  NULL),

-- ra 33 · 2 disciplinas
(33, 10, 3, '2025-02-12', 'Concluída', 5.5),
(33, 11, 3, '2025-02-12', 'Ativa',     NULL),

-- ra 86 (novo) · 2 disciplinas
(86,  9, 3, '2025-03-05', 'Ativa',     NULL),
(86, 12, 3, '2025-03-05', 'Ativa',     NULL),

-- ra 87 (novo) · 1 disciplina
(87, 10, 3, '2025-03-06', 'Trancada',  NULL),

-- ── Turma 4 — Agronegócio (disciplinas 13–16) ────────────
-- Alunos ra 46,47,48 (seed) + ra 91,92 (novos)

-- ra 46 · 3 disciplinas
(46, 13, 4, '2025-02-10', 'Concluída', 10.0),
(46, 14, 4, '2025-02-10', 'Concluída',  8.5),
(46, 15, 4, '2025-02-10', 'Ativa',     NULL),

-- ra 47 · 2 disciplinas
(47, 13, 4, '2025-02-11', 'Ativa',     4.0),
(47, 16, 4, '2025-02-11', 'Trancada',  NULL),

-- ra 48 · 2 disciplinas
(48, 14, 4, '2025-02-12', 'Concluída', 7.0),
(48, 15, 4, '2025-02-12', 'Ativa',     NULL),

-- ra 91 (novo) · 2 disciplinas
(91, 13, 4, '2025-03-07', 'Ativa',     NULL),
(91, 16, 4, '2025-03-07', 'Ativa',     NULL),

-- ra 92 (novo) · 1 disciplina
(92, 14, 4, '2025-03-08', 'Trancada',  NULL),

-- ── Turma 5 — Produção Sucroalcooleira (disc. 17–20) ─────
-- Alunos ra 61,62,63 (seed) + ra 96,97 (novos)

-- ra 61 · 3 disciplinas
(61, 17, 5, '2025-02-10', 'Concluída', 8.0),
(61, 18, 5, '2025-02-10', 'Concluída', 9.0),
(61, 19, 5, '2025-02-10', 'Ativa',     NULL),

-- ra 62 · 2 disciplinas
(62, 17, 5, '2025-02-11', 'Ativa',     6.0),
(62, 20, 5, '2025-02-11', 'Trancada',  NULL),

-- ra 63 · 2 disciplinas
(63, 18, 5, '2025-02-12', 'Concluída', 7.5),
(63, 19, 5, '2025-02-12', 'Ativa',     NULL),

-- ra 96 (novo) · 2 disciplinas
(96, 17, 5, '2025-03-09', 'Ativa',     NULL),
(96, 20, 5, '2025-03-09', 'Ativa',     NULL),

-- ra 97 (novo) · 1 disciplina
(97, 18, 5, '2025-03-10', 'Trancada',  NULL);

-- ══════════════════════════════════════════════════════════
-- VERIFICAÇÃO FINAL
-- ══════════════════════════════════════════════════════════
SELECT 'Total de alunos'    AS info, COUNT(*) AS total FROM aluno
UNION ALL
SELECT 'Total de matrículas',         COUNT(*) FROM matricula
UNION ALL
SELECT 'Matrículas Ativas',           COUNT(*) FROM matricula WHERE status = 'Ativa'
UNION ALL
SELECT 'Matrículas Concluídas',       COUNT(*) FROM matricula WHERE status = 'Concluída'
UNION ALL
SELECT 'Matrículas Trancadas',        COUNT(*) FROM matricula WHERE status = 'Trancada';